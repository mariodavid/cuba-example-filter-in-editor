...
public class CefieTestContainer extends TestContainer {

    public CefieTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cefie/app.properties",
    ...
    public static class Common extends CefieTestContainer {

        public static final CefieTestContainer.Common INSTANCE = new CefieTestContainer.Common();
